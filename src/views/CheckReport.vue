<template> 
     <div class="check_report">
        <div class="hed"><span>审核业务</span></div>
        <div class="line"></div>
        <div class="params">    
            ...
            <div class="status">
                ...
                <label>
                    <input type="radio" name="status" v-model="status" value="1" @click="sendReq">未审核
                </label>
                 <label>
                    <input type="radio" name="status" v-model="status" value="2" @click="sendReq">审核通过
                </label>   
            </div>
        </div>
        <div class="display">
            <div class="table-container">
                ...
                <tbody>
                    ...
                    <tr v-for="(item,index) of data" :key=item.id>
                       ...
                       <td>{{item.sub_date}}</td>
                        <td class="checked">
                            <router-link to="/404">通过</router-link>
                            <router-link to="/404">不通过</router-link>
                        </td>
                        <td>
                            流程图
                        </td>
    ...
    setup(){
        ...
        const sendReq = () =>{
           setTimeout(() => {
                ...
                data.value = [
                    {id:1,name: '海洋油气业企事业月表',type: '海洋油气业',report_date:'2013年12月',com:'江门市银星船舶工程有限公司',sub_date:'2014-12-13'},
                    {id:2,name: '海洋油气业企事业月表',type: '海洋油气业',report_date:'2013年12月',com:'江门市银星船舶工程有限公司',sub_date:'2014-12-13'}

                ]
                check.value = new Array(data.value.length).fill(false)
           })
        }
